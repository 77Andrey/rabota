...
const faqs = [
  {
    question: "Что реально входит в фиксированные 30 000 руб.?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Два раунда правок входят в стоимость: после прототипа и после готовой сборки. Всё, что было в согласованном брифе — дорабатываем бесплатно. Новые фичи оцениваем отдельно по фиксированной ставке 1 500 руб./час. Баги чиним без ограничений.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Это ок. Поможем с позиционированием, подготовим тексты, найдем стоковые визуалы и соберём UI. Если нужен фирменный стиль, можем подключить дизайн-партнёров (от 8 000 руб.).",
  },
]
